const labels = {
  ...
  author: {
    error: {
      es: 'El autor ingresado es inválido',
      en: 'The entered author is invalid',
    },
    placeholder: {
      es: 'Autor',
      en: 'Author',
  ...
  image: {
    error: {
      es: 'La foto del evento es inválida',
      en: "The event's photo is invalid",
    },
  },
  buttons: {
    confirm: {
  ...
  categoryCreated: {
    ...
    description: {
      es: 'La categoría se usará automáticamente en el evento que será creando',
      en: 'The category will be automatically used in the event that will be created',
    },
  },
  tagCreated: {
    title: {
    ...
    description: {
      es: 'La etiqueta se usará automáticamente en el evento que será creando',
      en: 'The tag will be automatically used in the event that will be created',
    },
  },
