...
import labels from './delete-publication-confirmation.lang';

@Component({
  standalone: true,
  selector: 'app-delete-publication-confirmation',
  templateUrl: './delete-publication-confirmation.component.html',
  imports: [FormsModule],
})
export class DeletePublicationConfirmationComponent {
