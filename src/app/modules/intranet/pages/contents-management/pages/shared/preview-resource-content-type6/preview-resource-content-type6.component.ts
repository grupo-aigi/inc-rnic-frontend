...
import labels from './preview-resource-content-type6.lang';

@Component({
  standalone: true,
  selector: 'app-preview-resource-content-type6',
  templateUrl: './preview-resource-content-type6.component.html',
  imports: [CommonModule],
})
export class PreviewResourceContentType6Component implements OnChanges {
  ...
  public resourceContent!: ResourceContentType6;
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    this.resourceContent = this.resource as ResourceContentType6;
  }
