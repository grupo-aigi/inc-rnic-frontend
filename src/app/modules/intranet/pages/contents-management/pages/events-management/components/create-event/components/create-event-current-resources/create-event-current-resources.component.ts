...
import { PreviewEventBaseInfoComponent } from '../preview-event-base-info/preview-event-base-info.component';
import { LangService } from '../../../../../../../../../../services/shared/lang/lang.service';
import labels from './create-event-current-resources.lang';

@Component({
  standalone: true,
  selector: 'app-create-event-current-resources',
  templateUrl: './create-event-current-resources.component.html',
  imports: [
    PreviewEventBaseInfoComponent,
...
export class CreateEventCurrentResourcesComponent {
  @Input() public currentResources: ResourceContent[] = [];
  @Input() public baseInfo!: EventBaseInfo;
  @Output() public onMoveUp: EventEmitter<number> = new EventEmitter();
  @Output() public onMoveDown: EventEmitter<number> = new EventEmitter();
