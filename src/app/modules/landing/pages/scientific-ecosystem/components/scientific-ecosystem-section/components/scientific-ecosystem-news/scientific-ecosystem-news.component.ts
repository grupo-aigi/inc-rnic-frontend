...
import labels from './scientific-ecosystem-news.lang';

@Component({
  standalone: true,
  selector: 'app-scientific-ecosystem-news',
  templateUrl: './scientific-ecosystem-news.component.html',
  imports: [
    ReactiveFormsModule,
    FormsModule,
    CommonModule,
...
export class ScientificEcosystemNewsComponent implements OnInit {
