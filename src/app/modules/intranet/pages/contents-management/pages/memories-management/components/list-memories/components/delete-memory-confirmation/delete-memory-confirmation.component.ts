...
import labels from './delete-memory-confirmation.lang';

@Component({
  standalone: true,
  selector: 'app-delete-memory-confirmation',
  templateUrl: './delete-memory-confirmation.component.html',
  imports: [FormsModule],
})
export class DeleteMemoryConfirmationComponent {
