...
import labels from './delete-news-confirmation.lang';

import { FormsModule } from '@angular/forms';

@Component({
  standalone: true,
  selector: 'app-delete-news-confirmation',
  templateUrl: './delete-news-confirmation.component.html',
  imports: [FormsModule],
})
export class DeleteNewsConfirmationComponent {
