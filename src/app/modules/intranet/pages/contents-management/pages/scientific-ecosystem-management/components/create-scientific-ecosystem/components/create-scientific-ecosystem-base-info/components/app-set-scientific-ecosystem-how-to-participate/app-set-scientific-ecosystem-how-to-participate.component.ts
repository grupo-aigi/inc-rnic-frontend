  ...
  implements OnInit, OnChanges
{
  ...
  @Input() public baseInfo: ScientificEcosystemDetailHowToParticipate | null =
    null;
  ...
  private loadExistingData(): void {
    ...
    const currentSection = createInfo.detail.sections.find(
      (section) => section.TYPE === 'COMO_PARTICIPAR',
    ) as ScientificEcosystemDetailHowToParticipate | undefined;
