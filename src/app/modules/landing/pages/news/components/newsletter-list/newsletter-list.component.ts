...
import { NewsletterListModalComponent } from '../newsletter-list-modal/newsletter-list-modal.component';
import labels from './newsletter-list.lang';
...
@Component({
  ...
  imports: [NewsletterListModalComponent],
})
export class NewsletterListComponent implements OnInit {
  ...
  public showAllNewsletterModal: boolean = false;
  public constructor(
  ...
  public ngOnInit(): void {
    ...
    this.newsletterService
      .fetchNewslettersSummaries(currYear - 1, currYear)
      .subscribe((value) => {
