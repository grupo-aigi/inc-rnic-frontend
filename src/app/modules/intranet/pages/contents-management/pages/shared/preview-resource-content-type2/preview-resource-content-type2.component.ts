...
import labels from './preview-resource-content-type2.lang';

@Component({
  standalone: true,
  selector: 'app-preview-resource-content-type2',
  templateUrl: './preview-resource-content-type2.component.html',
  imports: [CommonModule],
})
export class PreviewResourceContentType2Component implements OnChanges {
  ...
  public resourceContent!: ResourceContentType2;
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    this.resourceContent = this.resource as ResourceContentType2;
  }
