...
import labels from './delete-facilitator-confirmation.lang';
import { FormsModule } from '@angular/forms';


@Component({
  standalone: true,
  selector: 'app-delete-facilitator-confirmation',
  templateUrl: './delete-facilitator-confirmation.component.html',
  imports: [FormsModule],
})
export class DeleteFacilitatorConfirmationComponent {
  @Input() public title!: { en: string; es: string };
  @Output() public onConfirm: EventEmitter<void> = new EventEmitter<void>();
  @Input()
  public valueToType!: string;
