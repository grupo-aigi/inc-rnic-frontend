...
import labels from './preview-resource-content-type1.lang';

@Component({
  standalone: true,
  selector: 'app-preview-resource-content-type1',
  templateUrl: './preview-resource-content-type1.component.html',
  imports: [CommonModule],
})
export class PreviewResourceContentType1Component implements OnChanges {
  ...
  public resourceContent!: ResourceContentType1;
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    this.resourceContent = this.resource as ResourceContentType1;
  }
