...
import labels from './delete-coordinator-confirmation.lang';

@Component({
  standalone: true,
  selector: 'app-delete-coordinator-confirmation',
  templateUrl: './delete-coordinator-confirmation.component.html',
  imports: [FormsModule],
})
export class DeleteCoordinatorConfirmationComponent {
