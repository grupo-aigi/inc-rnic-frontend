...
import { PreviewConvocationBaseInfoComponent } from '../preview-convocation-base-info/preview-convocation-base-info.component';
import { LangService } from '../../../../../../../../../../services/shared/lang/lang.service';
import labels from './create-convocation-current-resources.lang';

@Component({
  standalone: true,
  selector: 'app-create-convocation-current-resources',
  templateUrl: './create-convocation-current-resources.component.html',
  imports: [
    PreviewConvocationBaseInfoComponent,
...
export class CreateConvocationCurrentResourcesComponent {
