...
import labels from './create-resource-content-type8.lang';

@Component({
  standalone: true,
  selector: 'app-create-resource-content-type8',
  templateUrl: './create-resource-content-type8.component.html',
  imports: [ReactiveFormsModule, UploadOrReuseImageComponent],
})
export class CreateResourceContentType8Component {
  @Input() public target!: ContentTarget;
  @Output() public onSubmit: EventEmitter<ResourceContentType8> =
    new EventEmitter();
  ...
  public handleSubmit() {
    ...
    const resource: ResourceContentType8 = {
      title,
      paragraphs: this.paragraphs,
      quotes: this.quotes,
      TYPE: 'CONTENT__QUOTES_FEEDBACKS_OR_REFERENCES_2',
    };
