const labels = {
  ...
  errorCreatingScientificEcosystem: {
    es: 'Ha habido un error al intentar crear el ecosistema científico',
    en: 'There was an error trying to create the scientific Ecosystem',
  },
  confirmUpdate: {
